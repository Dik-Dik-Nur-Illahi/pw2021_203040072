  ...
  <section>
    <div class="container">
      ...
      <form action="" method="POST" enctype="multipart/form-data">
        ...
        <img src="../assets/img/onroad/<?= $m['gambar']; ?>" width="120" style="display: block;" class="img-preview">
        <div class="row">
          ...
          <button type="submit" name="ubahon" class="waves-effect waves-light btn col s7 black">ubah</button>
        </div>
      </form>
    </div>
    </div>
