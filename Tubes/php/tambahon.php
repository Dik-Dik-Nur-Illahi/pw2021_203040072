  ...
  <section>
    <div class="container">
      ...
      <form action="" method="POST" enctype="multipart/form-data">
        ...
        <img src="../assets/img/onroad/noimg.png" width="300" style="display: block;" class="img-preview">
        <div class="row">
          ...
          <button type="submit" name="tambahon" class="waves-effect waves-light btn col s7 black">Tambah</button>
        </div>
      </form>
    </div>
    </div>
