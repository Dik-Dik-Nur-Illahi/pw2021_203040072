    ...
    <section class="detail" style="padding-top: 60px;">
      <div class="row">
        ...
        <div class="col s6">
          ...
          <a href="ubahoff.php?id=<?= $m['id']; ?>" class="waves-effect waves-light btn-large col s5 black boton" style="margin-left: 30px; margin-top: 20px;">Ubah</a>
          <a href="hapusoff.php?id=<?= $m['id']; ?>" onclick="return confirm('apakah anda yakin ingin menghapus data?');" class="waves-effect waves-light btn-large col s5 black boton" style="margin-left: 10px; margin-top: 20px;">Hapus</a>
        </div>
